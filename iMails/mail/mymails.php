                      ...
                      <div class="modal fade" id="myModal">
                        <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="box">
                                <form method="post" enctype="multipart/form-data"><br>
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="input-box">
                                        <input type="text" id="to" name="m_to" required onclick="record()"autocomplete="off"/>
                                        <label>To *</label>
                                      </div>
                                      <script>
                            function record() {
                            ...
                            // console.log(event);
                            document.getElementById('to').value = event.results[0][0].transcript.replace(/ /g, '')+"@imails.tk";
                                }
                            recognition.start();
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="input-box">
                                        <input type="text" id="sub"onclick="record1()" name="m_sub" autocomplete="off" />
                                        <label>Sub *</label>
                                      </div>
                                      <script>
                            function record1() {
                            ...
                            recognition.onresult = function(event) {
                            // console.log(event);
                            document.getElementById('sub').value = event.results[0][0].transcript;
                                }
                            recognition.start();
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="input-box">
                                        <textarea name="m_msg" id="msg" rows="4" autocomplete="off" onclick="record2()"></textarea>
                                        <label>Message *</label>
                                      </div>
                                      <script>
                            function record2() {
