...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2020 at 04:39 PM
...
INSERT INTO `customers` (`C_id`, `Fname`, `Lname`, `B_date`, `Gender`, `Password`) VALUES
('Aryan@imails.tk', 'Aryan', 'Patel', NULL, NULL, 'Aryan'),
('Prince@imails.tk', 'Prince', 'Patel', NULL, NULL, 'Prince');
...
INSERT INTO `mails` (`M_id`, `c_1`, `c_2`, `sub`, `message`, `date`, `read`, `star`, `trash`, `draft`) VALUES
(1, 'Aryan@imails.tk', 'Prince@imails.tk', 'hello', 'I am Aryan Patel', '2020-10-04 08:29:00', 0, 0, 0, 0);
...
INSERT INTO `recovery` (`C_id`, `Mail`, `verified`) VALUES
('Prince@imails.tk', NULL, 0),
('Aryan@imails.tk', NULL, 0);
...
INSERT INTO `theme` (`C_id`, `theme`, `Date`) VALUES
('Prince@imails.tk', '1', '2020-10-04 08:24:37'),
('Aryan@imails.tk', '1', '2020-10-04 08:26:49');
